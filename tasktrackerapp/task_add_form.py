...
class TaskAdd(FlaskForm):
    ...
    status = StringField(default='OPEN', render_kw={'class':'form-control'})
    deadline = DateField("Срок исполнения до", validators=[DataRequired()], render_kw={'class':'form-control'})
